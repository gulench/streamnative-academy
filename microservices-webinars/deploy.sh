...
kubectl exec -it pulsar-toolset-0 -n workshop -- /pulsar/bin/pulsar-admin functions create \
...
kubectl exec -it pulsar-toolset-0 -n workshop -- /pulsar/bin/pulsar-admin source create \
